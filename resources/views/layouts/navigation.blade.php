            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center">
                        <img src="{{ asset('images/logo.png') }}" alt="Startup Sphere Logo" class="h-12 w-auto">
                        <span class="ml-2 text-xl font-bold text-gray-800">Startup Sphere</span>
                    </a>
                </div>
        ...
        @else
            <div class="pt-4 pb-1 border-t border-gray-200">
                <div class="space-y-1 px-4">
                    ...
                    <x-responsive-nav-link :href="route('register.organizer')">
